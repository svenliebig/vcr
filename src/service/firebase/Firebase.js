...
class Firebase {
	 ...
	 */
	write(node, value) {
		return this.db.ref(node).set(value).then(() => Promise.resolve())
	}
	 ...
	 */
	get(node) {
		return this.db.ref(node).once('value').then(snapshot => Promise.resolve(snapshot.val()))
	}
	 ...
	 */
	remove(node) {
		return this.db.ref(node).remove().then(() => Promise.resolve())
	}
	 ...
	 */
	exists(node) {
		return this.db.ref(node).once('value').then(snapshot => Promise.resolve(snapshot.exists()))
	}
